...
//   const handleTestNameChange = (index, event) => {
//     if (testNames[index]) {
//       return; // If a test name is already present, don't allow changes
//     }
//     const updatedTestNames = [...testNames];
//     updatedTestNames[index] = event.target.value;
//     setTestNames(updatedTestNames);
...
//   const handleSaveTestName = async (code, testName, index) => {
//     if (!testNames[testNames.indexOf(testName)]) {
//       await saveTestNameToDatabase(code, testName);
//       const updatedTestNames = [...testNames];
//       updatedTestNames[index] = testName;
//       setTestNames(updatedTestNames);
//     }
//   };
...
//                       <button
//                         className="bg-teal-500 hover:bg-teal-700 text-white text-sm py-1 px-2 rounded ml-2 focus:outline-none"
//                         onClick={() => handleSaveTestName(form.code, testNames[index], index)}
//                       >
//                         Ok
//                       </button>
//                     </>
...
//                       </ul>
//                       {question.correctAnswer && question.correctAnswer.trim() !== '' ? (
//                         <p className="text-green-600 mt-2">Correct Answer: {question.correctAnswer}</p>
//                       ) : (
//                         <p className="text-red-600 mt-2">No correct answer available</p>
//                       )}
//                     </div>
